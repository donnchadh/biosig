...
#include "MetricDescriptiveDataSection.h"
...
static asn_SET_OF_specifics_t asn_SPC_vmosourcelist_specs_13 = {
	sizeof(struct MetricDescriptiveDataSection__vmosourcelist),
	offsetof(struct MetricDescriptiveDataSection__vmosourcelist, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_metricsourcelist_specs_15 = {
	sizeof(struct MetricDescriptiveDataSection__metricsourcelist),
	offsetof(struct MetricDescriptiveDataSection__metricsourcelist, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_SET_OF_specifics_t asn_SPC_msmtsitelist_specs_17 = {
	sizeof(struct MetricDescriptiveDataSection__msmtsitelist),
	offsetof(struct MetricDescriptiveDataSection__msmtsitelist, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_SET_OF_specifics_t asn_SPC_msmtsitelistext_specs_19 = {
	sizeof(struct MetricDescriptiveDataSection__msmtsitelistext),
	offsetof(struct MetricDescriptiveDataSection__msmtsitelistext, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_SET_OF_specifics_t asn_SPC_bodysitelist_specs_21 = {
	sizeof(struct MetricDescriptiveDataSection__bodysitelist),
	offsetof(struct MetricDescriptiveDataSection__bodysitelist, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_SET_OF_specifics_t asn_SPC_bodysitelistext_specs_23 = {
	sizeof(struct MetricDescriptiveDataSection__bodysitelistext),
	offsetof(struct MetricDescriptiveDataSection__bodysitelistext, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_SET_OF_specifics_t asn_SPC_metriccalibration_specs_25 = {
	...
	offsetof(struct MetricDescriptiveDataSection__metriccalibration, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_MetricDescriptiveDataSection_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MetricDescriptiveDataSection, handle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MetricDescriptiveDataSection, devicehandle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MetricDescriptiveDataSection, metrictype),
	...
	{ ATF_POINTER, 24, offsetof(struct MetricDescriptiveDataSection, labelstring),
	...
	{ ATF_POINTER, 23, offsetof(struct MetricDescriptiveDataSection, metriccategory),
	...
	{ ATF_POINTER, 22, offsetof(struct MetricDescriptiveDataSection, metricstatus),
	...
	{ ATF_POINTER, 21, offsetof(struct MetricDescriptiveDataSection, measurementstatus),
	...
	{ ATF_POINTER, 20, offsetof(struct MetricDescriptiveDataSection, metricid),
	...
	{ ATF_POINTER, 19, offsetof(struct MetricDescriptiveDataSection, metricidext),
	...
	{ ATF_POINTER, 18, offsetof(struct MetricDescriptiveDataSection, unitcode),
	...
	{ ATF_POINTER, 17, offsetof(struct MetricDescriptiveDataSection, unitlabelstring),
	...
	{ ATF_POINTER, 16, offsetof(struct MetricDescriptiveDataSection, vmosourcelist),
		(ASN_TAG_CLASS_APPLICATION | (2467 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 15, offsetof(struct MetricDescriptiveDataSection, metricsourcelist),
		(ASN_TAG_CLASS_APPLICATION | (2366 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 14, offsetof(struct MetricDescriptiveDataSection, msmtsitelist),
		(ASN_TAG_CLASS_APPLICATION | (2430 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 13, offsetof(struct MetricDescriptiveDataSection, msmtsitelistext),
		(ASN_TAG_CLASS_APPLICATION | (2551 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 12, offsetof(struct MetricDescriptiveDataSection, bodysitelist),
		(ASN_TAG_CLASS_APPLICATION | (2429 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 11, offsetof(struct MetricDescriptiveDataSection, bodysitelistext),
		(ASN_TAG_CLASS_APPLICATION | (2550 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 10, offsetof(struct MetricDescriptiveDataSection, metriccalibration),
		(ASN_TAG_CLASS_APPLICATION | (2362 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 9, offsetof(struct MetricDescriptiveDataSection, colour),
	...
	{ ATF_POINTER, 8, offsetof(struct MetricDescriptiveDataSection, measuremode),
	...
	{ ATF_POINTER, 7, offsetof(struct MetricDescriptiveDataSection, measureperiod),
	...
	{ ATF_POINTER, 6, offsetof(struct MetricDescriptiveDataSection, averagingperiod),
	...
	{ ATF_POINTER, 5, offsetof(struct MetricDescriptiveDataSection, starttime),
	...
	{ ATF_POINTER, 4, offsetof(struct MetricDescriptiveDataSection, stoptime),
	...
	{ ATF_POINTER, 3, offsetof(struct MetricDescriptiveDataSection, metricinfolabelstring),
	...
	{ ATF_POINTER, 2, offsetof(struct MetricDescriptiveDataSection, substance),
	...
	{ ATF_POINTER, 1, offsetof(struct MetricDescriptiveDataSection, substancelabelstring),
...
static ber_tlv_tag_t asn_DEF_MetricDescriptiveDataSection_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MetricDescriptiveDataSection_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_MetricDescriptiveDataSection_specs_1 = {
	sizeof(struct MetricDescriptiveDataSection),
	offsetof(struct MetricDescriptiveDataSection, _asn_ctx),
	asn_MAP_MetricDescriptiveDataSection_tag2el_1,
	27,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_MetricDescriptiveDataSection = {
	...
	0, 0,	/* No PER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_MetricDescriptiveDataSection_tags_1,
	sizeof(asn_DEF_MetricDescriptiveDataSection_tags_1)
		/sizeof(asn_DEF_MetricDescriptiveDataSection_tags_1[0]), /* 1 */
	asn_DEF_MetricDescriptiveDataSection_tags_1,	/* Same as above */
	sizeof(asn_DEF_MetricDescriptiveDataSection_tags_1)
		/sizeof(asn_DEF_MetricDescriptiveDataSection_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_MetricDescriptiveDataSection_1,
	27,	/* Elements count */
	&asn_SPC_MetricDescriptiveDataSection_specs_1	/* Additional specs */
};
