...
#ifndef	_SampleArrayDescriptiveDataSection_H_
#define	_SampleArrayDescriptiveDataSection_H_
...
typedef struct SampleArrayDescriptiveDataSection {
	Handle_t	 handle;
	...
	struct SampleArrayDescriptiveDataSection__vmosourcelist {
		A_SEQUENCE_OF(MetricsCode_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *vmosourcelist;
	struct SampleArrayDescriptiveDataSection__metricsourcelist {
		A_SEQUENCE_OF(HandleRef_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *metricsourcelist;
	struct SampleArrayDescriptiveDataSection__msmtsitelist {
		A_SEQUENCE_OF(BodySiteCode_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *msmtsitelist;
	struct SampleArrayDescriptiveDataSection__msmtsitelistext {
		A_SEQUENCE_OF(struct ExtNomenRef) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *msmtsitelistext;
	struct SampleArrayDescriptiveDataSection__bodysitelist {
		A_SEQUENCE_OF(BodySiteCode_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *bodysitelist;
	struct SampleArrayDescriptiveDataSection__bodysitelistext {
		A_SEQUENCE_OF(struct ExtNomenRef) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *bodysitelistext;
	struct SampleArrayDescriptiveDataSection__metriccalibration {
	...
	struct SampleArrayDescriptiveDataSection__visualgrid {
	...
	struct SampleArrayDescriptiveDataSection__filterspecification {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} SampleArrayDescriptiveDataSection_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_SampleArrayDescriptiveDataSection;
...
#endif	/* _SampleArrayDescriptiveDataSection_H_ */
