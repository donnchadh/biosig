...
#ifndef	_TimeSampleArrayDescriptiveDataSection_H_
#define	_TimeSampleArrayDescriptiveDataSection_H_
...
typedef struct TimeSampleArrayDescriptiveDataSection {
	Handle_t	 handle;
	...
	struct TimeSampleArrayDescriptiveDataSection__vmosourcelist {
		A_SEQUENCE_OF(MetricsCode_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *vmosourcelist;
	struct TimeSampleArrayDescriptiveDataSection__metricsourcelist {
		A_SEQUENCE_OF(HandleRef_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *metricsourcelist;
	struct TimeSampleArrayDescriptiveDataSection__msmtsitelist {
		A_SEQUENCE_OF(BodySiteCode_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *msmtsitelist;
	struct TimeSampleArrayDescriptiveDataSection__msmtsitelistext {
		A_SEQUENCE_OF(struct ExtNomenRef) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *msmtsitelistext;
	struct TimeSampleArrayDescriptiveDataSection__bodysitelist {
		A_SEQUENCE_OF(BodySiteCode_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *bodysitelist;
	struct TimeSampleArrayDescriptiveDataSection__bodysitelistext {
		A_SEQUENCE_OF(struct ExtNomenRef) list;
	...
	struct TimeSampleArrayDescriptiveDataSection__visualgrid {
		A_SEQUENCE_OF(struct SaGridEntry) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *visualgrid;
	struct TimeSampleArrayDescriptiveDataSection__sacalibrationdata {
		A_SEQUENCE_OF(struct SaCalData) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *sacalibrationdata;
	struct TimeSampleArrayDescriptiveDataSection__filterspecification {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TimeSampleArrayDescriptiveDataSection_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TimeSampleArrayDescriptiveDataSection;
...
#endif	/* _TimeSampleArrayDescriptiveDataSection_H_ */
