/*
%
% $Id: biosig_vs.h,v 1.1 2006-04-28 17:11:00 schloegl Exp $
...
#ifdef VS_DEF
#define t_time2gdf_time(t)	((gdf_time)floor(ldexp(((double)t)/86400.0 + 719529L, 32)))
...
#define	ntp_time2gdf_time(t)	((gdf_time)ldexp(ldexp(((double)t),-32)/86400 + 719529 - 70,32))
#define	gdf_time2ntp_time(t)	((int64_t)ldexp((ldexp(((double)t),-32) - 719529 + 70) * 86400,32))
#else
