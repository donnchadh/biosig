...
% [3] Schl√∂gl A., Neuper C. Pfurtscheller G.
%       Estimating the mutual information of an EEG-based Brain-Computer-Interface
%       Biomedizinische Technik 47(1-2): 3-8, 2002.
% [4] A. Schl√∂gl, C. Keinrath, R. Scherer, G. Pfurtscheller,
...
% [5] A. Schl√∂gl, J. Kronegg, J.E. Huggins, S. G. Mason.
...
% [6] A. Schl√∂gl, F.Y. Lee, H. Bischof, G. Pfurtscheller
...
%   2a: Overflowdetection: eeghist.m, [Schlˆgl et al. 1999] 
...
fprintf(1,'\t Fig 3+: various evaluation criteria [Schlˆgl et al. 2007] for comparing different features ');
